...
const INTEGRATIONS = [
  ...
  {
    name: "Telegram Bot",
    description: "Talk to your Loop via Telegram. Natural conversation for tasks, research, and negotiations.",
    status: "Coming Soon",
    envKey: "TELEGRAM_BOT_TOKEN",
    docs: "Create bot via @BotFather → set token → webhook auto-registers",
  },
  {
    name: "Slack App",
    description: "Get Loop updates in Slack channels. Assign tasks via @mention. Deal alerts and daily summaries.",
    status: "Coming Soon",
    envKey: "SLACK_BOT_TOKEN",
    docs: "Slack app submission in progress",
  },
  {
    name: "Google Calendar",
    description: "Your Loop books appointments directly on your Google Calendar. Auto-scheduling and conflict detection.",
    status: "Coming Soon",
    envKey: "Google Calendar API scope",
    docs: "OAuth integration planned",
  },
  {
    name: "Email Inbound",
    description: "Forward emails to your Loop. It reads, understands, and acts — replies, files, extracts data.",
    status: "Coming Soon",
    envKey: "MX records + inbound parse webhook",
    docs: "Requires custom domain with MX routing",
  },
];
